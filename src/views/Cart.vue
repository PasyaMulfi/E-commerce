      ...
      <div class="rounded-lg md:w-2/3">
        <div v-for="cart in getCart" :key="cart.cart_id">
          <div class="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
            <img src="https://ecommerce.olipiskandar.com/public/uploads/all/UpUx213sXC5XBW07vbXn1vkWMWxTu95CDDbMzwkF.jpg"
              ...
              <div class="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                <div class="flex items-center border-gray-100">
                  <span
                    ...
                    @click="changeQty({ cartId: cart.cart_id, typeQty: 'minus' })"> - </span>
                  <input class="h-8 w-8 border bg-white text-center text-xs outline-none" type="" :value="cart.qty"
                    min="1" />
                  <span
                    class="cursor-pointer rounded-r bg-gray-100 py-1 px-3 duration-100 hover:bg-blue-500 hover:text-blue-50"
                    @click="changeQty({ cartId: cart.cart_id, typeQty: 'plus' })"> + </span>
                </div>
